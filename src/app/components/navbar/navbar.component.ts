      ...
      <div class="section-container">
        <div class="flex items-center justify-between h-20">
          ...
          <div class="hidden md:flex items-center space-x-8">
            <a href="#features" class="text-gray-700 hover:text-primary-600 transition-colors font-medium">Características</a>
            <a href="#stats" class="text-gray-700 hover:text-primary-600 transition-colors font-medium">Estadísticas</a>
            <a href="#download" class="btn-primary">Descargar</a>
          </div>
        ...
        <div 
          *ngIf="isMenuOpen"
          ...
          <a href="#features" (click)="toggleMenu()" [class]="'block transition-colors font-medium py-2 ' + (isScrolled ? 'text-white hover:text-primary-200' : 'text-gray-700 hover:text-primary-600')">Características</a>
          <a href="#stats" (click)="toggleMenu()" [class]="'block transition-colors font-medium py-2 ' + (isScrolled ? 'text-white hover:text-primary-200' : 'text-gray-700 hover:text-primary-600')">Estadísticas</a>
          <a href="#download" (click)="toggleMenu()" class="block btn-primary text-center">Descargar</a>
        </div>
      </div>
    </nav>
  `,
